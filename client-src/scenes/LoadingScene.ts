...
const verbose = Debug('superfluous-laser:LoadingScene:verbose');
const log = Debug('superfluous-laser:LoadingScene:log');
// const warn = Debug('superfluous-laser:LoadingScene:warn');
