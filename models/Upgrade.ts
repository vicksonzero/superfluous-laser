import { AttributeType, config, IPartList, ItemsList, ItemType, PartType } from '../config/gameConfig';
import { Immutable } from '../utils/ImmutableType';
import { capitalize } from '../utils/utils';
import * as Debug from 'debug';

const log = Debug('superfluous-laser:UpgradeObject:log');
const warn = Debug('superfluous-laser:UpgradeObject:warn');
